...
def build_vocabulary(image_paths, vocab_size):
    ...
    choice_idx = np.random.choice(bag_of_features.shape[0], 200000, replace=False)
    bag_of_features = bag_of_features[choice_idx,:]
    print("bag_of_features_shape:{}".format(bag_of_features.shape))
    print("Compute vocab")
    start_time = time()
